  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 md:px-12 text-center flex flex-col items-center">
        ...
        >
          <Link to="/analyze" className="group relative px-9 py-4 rounded-full bg-primary text-background font-bold text-base transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center gap-2">
      ...
      <section id="how-it-works" className="max-w-7xl mx-auto px-6 md:px-12 mt-40 scroll-mt-32">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
      ...
      {/* Features Section */}
      <section id="features" className="max-w-7xl mx-auto px-6 md:px-12 mt-40 scroll-mt-32">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
